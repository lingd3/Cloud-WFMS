 ...
 */
public class LBLMBRule extends RoundRobinRule {

    private static Logger logger = LoggerFactory.getLogger(LBLMBRule.class);
...
//            writerForBusyness = new FileWriter("LBLMB_busyness.txt");
        ...
        LBLMBRule.Task task = new LBLMBRule.Task();
        LBLMBRule.WriteLogTask writeLogTask = new LBLMBRule.WriteLogTask();
...
//       Server result = getMinBusynessServer(previousServers);
    ...
    private class Task implements  Runnable {
        @Override
        public void run() {
            LBLMBRule.this.updateServerHistoryBusyness();
        }
    }
